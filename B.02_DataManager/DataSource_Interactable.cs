    ...
    public class DataSource_Interactable : DataSourceBase<DataSource_Interactable.DataStructure, DataSource_Interactable.RecordingConfig>
    {
        ...
        public override Dictionary<string, object> CollectData()
        {
            ...
            if (true)
            {
                ...
                if (RecordConfig.EyeGazedObject)
                {
                    data["GazedObjectEye"] = Data.EyeGazedObject?.name;
                }
                if (RecordConfig.HeadGazedObject)
                {
                    data["GazedObjectHead"] = Data.HeadGazedObject?.name;

                }
                if (RecordConfig.ChestGazedObject)
                {
                    data["GazedObjectChest"] = Data.ChestGazedObject?.name;
        ...
        public class DataStructure
        {
            ...
            //Gazed Objects
            public GameObject EyeGazedObject => _gazeInteractor.GetCurrentlyGazedObject(Gaze_Interactor.Interactors.EYE);
            public GameObject HeadGazedObject => _gazeInteractor.GetCurrentlyGazedObject(Gaze_Interactor.Interactors.HEAD);
            public GameObject ChestGazedObject => _gazeInteractor.GetCurrentlyGazedObject(Gaze_Interactor.Interactors.CHEST);
        ...
        {
            [Header("Eye Options")]
            [Tooltip("Eye Gazed Object")]
            public bool EyeGazedObject = true;

            [Header("Head Options")]
            [Tooltip("Head Gazed Object")]
            public bool HeadGazedObject = true;

            [Header("Chest Options")]
            [Tooltip("Chest Gazed Object")]
            public bool ChestGazedObject = true;
